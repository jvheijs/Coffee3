report 50007 "CS Service Invoice"
{
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Rep50007/Rep50007.ServiceInvoice.rdlc';
        ...
        dataitem("Service Invoice Header"; "Service Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(PostingDate_ServInvHeader; Format("Service Invoice Header"."Posting Date", 0, 4))
                    {
                    }
                    ...
                    column(DueDate_ServInvHeader; Format("Service Invoice Header"."Due Date", 0, 4))
                    {
                    }
                    ...
                    dataitem("Service Invoice Line"; "Service Invoice Line")
                    {
                        ...
                        column(PostedShipmentDate; Format(PostedShipmentDate, 0, 4))
                        {
                        }
                        ...
                        {
                            DataItemTableView = sorting(Number);
                            column(ServShptBufferPostingDate; Format(TempServiceShipmentBuffer."Posting Date", 0, 4))
                            {
                            }
            ...
            begin
                ...
                // CS1.0 <<
                if lRecPayMethod.Get("Payment Method Code") then
                ...
                // Signature
                if SignatureRec.get(Database::"Service Invoice Header", "Service Invoice Header"."No.", 0) then
    ...
    var
        ...
        DeliveryAddressCaptionLbl: Label 'Verzend adres';
