report 50069 "Sales Invoice"
{
    ...
    // CS2.0         120219 JvH : Als "Bill-To Customer" 190000 is en "Bill-To Name 2" is gevuld, dan de "Bill-To Name" leeg maken.
    //                            Dit is voor klanten die de goederen komen afhalen bij Coffee3. 190000 is dan de "dummy" debiteur en
    //                            de naam is de klant die het komt afhalen.
    // CS2.0         260719 JvH : BTW specificatieblok niet meer vetgedrukt.
    // CS-I-1910_062 251019 JvH : Overige velden uit Sell-To halen. FormatAdres kan niet gebruikt worden. Verschil in arraylengte in Sell-To adres.
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Rep50069/Rep50069.SalesInvoice.rdlc';
        ...
        dataitem("Sales Invoice Header"; "Sales Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BilltoCustNo_InvHdr; "Sales Invoice Header"."Bill-to Customer No.")
                    {
                    }
                    column(PostingDate_InvHdr; Format("Sales Invoice Header"."Posting Date", 0, 4))
                    {
                    }
                    column(VATNoText; VATNoText)
                    {
                    }
                    column(VATRegNo_ServInvHdr; "Sales Invoice Header"."VAT Registration No.")
                    {
                    }
                    column(DueDate_ServInvHdr; Format("Sales Invoice Header"."Due Date", 0, 4))
                    {
                    }
                    ...
                    column(YourReference_InvHdr; "Sales Invoice Header"."Your Reference")
                    {
                    }
                    column(HdrOrderNo_InvHdr; "Sales Invoice Header"."Order No.")
                    {
                    }
                    ...
                    column(DocDate_ServInvHdr; Format("Sales Invoice Header"."Document Date", 0, 4))
                    {
                    }
                    column(PricesInclVAT_ServInvHdr; "Sales Invoice Header"."Prices Including VAT")
                    {
                    }
                    column(OutputNo; OutputNo)
                    {
                    }
                    column(PricesInclVATYesNo_ServInvHdr; Format("Sales Invoice Header"."Prices Including VAT"))
                    {
                    }
                    ...
                    column(Signature_Customer; gRecCompanyInformation.Picture)
                    {
                    }
                    dataitem("Sales Invoice Line"; "Sales Invoice Line")
                    {
                        ...
                        column(VATBaseDisc_ServInvHdr; "Sales Invoice Header"."VAT Base Discount %")
                        {
                            AutoFormatType = 1;
                        }
            ...
            begin
                ...
                if ("Sales Invoice Header"."Bill-to Customer No." = '190000') and                // CS-I-1910_062 <<
                   ("Sales Invoice Header"."Bill-to Name 2" <> '') then begin
                    "Sales Invoice Header"."Bill-to Name" := '';
                    "Sales Invoice Header"."Bill-to Address" := "Sales Invoice Header"."Sell-to Address";
                    "Sales Invoice Header"."Bill-to Address 2" := "Sales Invoice Header"."Sell-to Address 2";
                    "Sales Invoice Header"."Bill-to City" := "Sales Invoice Header"."Sell-to City";
                    "Sales Invoice Header"."Bill-to Post Code" := "Sales Invoice Header"."Sell-to Post Code";
                    "Sales Invoice Header"."Bill-to County" := "Sales Invoice Header"."Sell-to County";
                    "Sales Invoice Header"."Bill-to Country/Region Code" := "Sales Invoice Header"."Sell-to Country/Region Code";
                    "Sales Invoice Header"."Bill-to Contact No." := "Sales Invoice Header"."Sell-to Contact";
                end;                                                                          // CS-I-1910_062 >>
                ...
                if lRecPayMethod.Get("Payment Method Code") then begin
                    if "Payment Method Code" = '02' then
                        gTxtPayMethod := PaymentTerms.Description
                    else
    ...
    var
        ...
        gRecCompanyInformation: Record "Company Information" temporary;
