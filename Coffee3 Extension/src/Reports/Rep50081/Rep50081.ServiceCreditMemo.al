report 50081 "Service Credit-Memo"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Rep50081/Rep50081.ServiceCreditMemo.rdlc';

    Caption = 'Service Credit';
    ...
    dataset
    {
        ...
        dataitem("Service Cr.Memo Header"; "Service Cr.Memo Header")
        {
            ...
            column(PaymentMethod; BetWijze.Description)
            {
            }
            column(PaymentMethodCapt; PaymentMethodCaptLbl)
            {
            }
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BilltoCustNo_InvHdr; "Service Cr.Memo Header"."Bill-to Customer No.")
                    {
                    }
                    column(PostingDate_InvHdr; Format("Service Cr.Memo Header"."Posting Date", 0, 4))
                    {
                    }
                    column(VATNoText; VATNoText)
                    {
                    }
                    column(VATRegNo_ServInvHdr; "Service Cr.Memo Header"."VAT Registration No.")
                    {
                    }
                    column(DueDate_ServInvHdr; Format("Service Cr.Memo Header"."Due Date", 0, 4))
                    {
                    }
                    ...
                    column(YourReference_InvHdr; "Service Cr.Memo Header"."Your Reference")
                    {
                    }
                    ...
                    column(DocDate_ServInvHdr; Format("Service Cr.Memo Header"."Document Date", 0, 4))
                    {
                    }
                    column(PricesInclVAT_ServInvHdr; "Service Cr.Memo Header"."Prices Including VAT")
                    {
                    }
                    column(OutputNo; OutputNo)
                    {
                    }
                    column(PricesInclVATYesNo_ServInvHdr; Format("Service Cr.Memo Header"."Prices Including VAT"))
                    {
                    }
                    ...
                    dataitem("Service Cr.Memo Line"; "Service Cr.Memo Line")
                    {
                        ...
                        column(VATBaseDisc_ServInvHdr; "Service Cr.Memo Header"."VAT Base Discount %")
                        {
                            AutoFormatType = 1;
                        }
                    ...
                    dataitem(VatCounterLCY; "Integer")
                    {
                        ...
                        begin
                            ...
                            VALVATBaseLCY :=
                              VATAmountLine.GetBaseLCY(
                                "Service Cr.Memo Header"."Posting Date", "Service Cr.Memo Header"."Currency Code",
                                "Service Cr.Memo Header"."Currency Factor");
                            VALVATAmountLCY :=
                        ...
                        begin
                            if (not GLSetup."Print VAT specification in LCY") or
                               ("Service Cr.Memo Header"."Currency Code" = '')
                            then
                                CurrReport.Break();
                            ...
                            CurrExchRate.FindCurrency("Service Cr.Memo Header"."Posting Date", "Service Cr.Memo Header"."Currency Code", 1);
                            CalculatedExchRate := Round(1 / "Service Cr.Memo Header"."Currency Factor" * CurrExchRate."Exchange Rate Amount", 0.000001);
                    ...
                    {
                        DataItemTableView = sorting(Number) where(Number = const(1));
                        column(SelltoCustNo_ServInvHdr; "Service Cr.Memo Header"."Ship-to Code")
                        {
                        }
            ...
            begin
                ...
                // CS1.0 >>
                ShowShippingAddr := FormatAddr.ServiceCrMemoShipTo(ShipToAddr, CompanyAddr, "Service Cr.Memo Header");

                if "Service Cr.Memo Header"."Payment Method Code" = '' then
                    BetWijze.Init
                else
                    BetWijze.Get("Payment Method Code");
            end;
        }
    }
    ...
    var
        ...
        BetWijze: Record "Payment Method";
        ...
        ReportTitle: Label 'Service Credit';
        NoCaptionLbl: Label 'Credit No.';
        ...
        ">>CLAUSL": Integer;
        "<<CLAUSL": Integer;
        DeliveryAddressCaptionLbl: Label 'Verzendadres';                                 // jvh
        ...
        PaymentMethodCaptLbl: Label 'Payment method';
