report 50078 "Service Invoice"
{
    ...
    // CS2.0 120219 JvH : Setcurrentkey toegevoegd en veld "Totale korting" toegevoegd die totaal van de regelkorting weergeeft,
    //                    dit moest op 2 plekken i.v.m. normale totalen en totalen met BTW specificatie.
    // CS2.0 130219 JvH : Blok Verzendadres toegevoegd.
    // CS2.0 110619 JvH : EUR toegevoegd aan caption "Totale korting".
        ...
        dataitem("Service Invoice Header"; "Service Invoice Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(BilltoCustNo_InvHdr; "Service Invoice Header"."Bill-to Customer No.")
                    {
                    }
                    column(PostingDate_InvHdr; Format("Service Invoice Header"."Posting Date", 0, 4))
                    {
                    }
                    column(VATNoText; VATNoText)
                    {
                    }
                    column(VATRegNo_ServInvHdr; "Service Invoice Header"."VAT Registration No.")
                    {
                    }
                    column(DueDate_ServInvHdr; Format("Service Invoice Header"."Due Date", 0, 4))
                    {
                    }
                    ...
                    column(YourReference_InvHdr; "Service Invoice Header"."Your Reference")
                    {
                    }
                    column(HdrOrderNo_InvHdr; "Service Invoice Header"."Order No.")
                    {
                    }
                    ...
                    column(DocDate_ServInvHdr; Format("Service Invoice Header"."Document Date", 0, 4))
                    {
                    }
                    column(PricesInclVAT_ServInvHdr; "Service Invoice Header"."Prices Including VAT")
                    {
                    }
                    column(OutputNo; OutputNo)
                    {
                    }
                    column(PricesInclVATYesNo_ServInvHdr; Format("Service Invoice Header"."Prices Including VAT"))
                    {
                    }
                    ...
                    dataitem("Service Invoice Line"; "Service Invoice Line")
                    {
                        ...
                        column(DecTotalLineDiscAmout; gDecTotalLineDiscAmout)
                        {
                        }
                        ...
                        begin
                            ...
                            gDecTotalLineDiscAmout += "Line Discount Amount"; // CS2.0
                        end;
                    ...
                    dataitem(VatCounterLCY; "Integer")
                    {
                        ...
                        begin
                            ...
                            VALVATBaseLCY :=
                              VATAmountLine.GetBaseLCY(
                                "Service Invoice Header"."Posting Date", "Service Invoice Header"."Currency Code",
                                "Service Invoice Header"."Currency Factor");
                            VALVATAmountLCY :=
                        ...
                        begin
                            ...
                            CurrExchRate.FindCurrency("Service Invoice Header"."Posting Date", "Service Invoice Header"."Currency Code", 1);
                            CalculatedExchRate := Round(1 / "Service Invoice Header"."Currency Factor" * CurrExchRate."Exchange Rate Amount", 0.000001);
                    ...
                    {
                        DataItemTableView = sorting(Number) where(Number = const(1));
                        column(SelltoCustNo_ServInvHdr; "Service Invoice Header"."Ship-to Code")
                        {
                        }
                ...
                begin
                    ...
                    gDecTotalLineDiscAmout := 0; // CS2.0
                end;
            ...
            begin
                ...
                if "Service Invoice Header"."Ship-to Code" <> '' then begin
                    FormatAddr.ServiceInvShipTo(ShipToAddr, CompanyAddr, "Service Invoice Header");
    ...
    var
        ...
        ReportTitle: Label 'Service Invoice';
    ...
    begin
        SalesShipmentBuffer.SetCurrentKey("Document No.", "Line No.", "Posting Date");                // CS2.0
