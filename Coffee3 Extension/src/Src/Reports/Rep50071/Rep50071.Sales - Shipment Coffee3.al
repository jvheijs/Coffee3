report 50071 "Sales - Shipment Coffee3"
{
    Caption = 'Sales - Shipment';
    PreviewMode = PrintLayout;
    DefaultLayout = RDLC;
    RDLCLayout = './src/Reports/Rep50071/Rep50071.Sales - Shipment Coffee3.rdlc';
        ...
        dataitem("Sales Shipment Header"; "Sales Shipment Header")
        {
            ...
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(Signature_Customer; gRecCompanyInformationTmp.Picture)
                    {
                    }
                    ...
                    column(ShipmentNoCaption; 'Verzendnummer')
                    {
                    }
                    ...
                    column(SelltoCustNo_SalesShptHeaderCaption; 'Klantnummer')
                    {
                    }
                    ...
                    dataitem("Sales Shipment Line"; "Sales Shipment Line")
                    {
                        ...
                        column(No_SalesShptLineCaption; 'Artikel')
                        {
                        }
                        ...
                        trigger OnAfterGetRecord();
                        begin
                            if gBlnCompPictPrinted then
                                CLEAR(CompanyInfo.Picture)
                            else
                                gBlnCompPictPrinted := true;

                            if gBlnSignaturePrinted then
                                CLEAR(gRecCompanyInformationTmp.Picture)
                            else
                                gBlnSignaturePrinted := true;
    ...
    var
        ...
        LogoPadLeft: Integer;
        LogoPadTop: Integer;
        gRecCompanyInformationTmp: Record "Company Information" temporary;
        ...
        gBlnCompPictPrinted: Boolean;
        gBlnSignaturePrinted: Boolean;
